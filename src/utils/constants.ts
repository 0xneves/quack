...
// Stealth format: Quack://_:[iv]:[ciphertext] (no fingerprint, try all keys)
...
export const QUACK_STEALTH_PREFIX = 'Quack://_:';
...
// Stealth message: Quack://_:[base64]:[base64] (no fingerprint)
export const QUACK_STEALTH_REGEX = /Quack:\/\/_:[A-Za-z0-9+/=]+:[A-Za-z0-9+/=]+/g;
// Legacy 1-to-1: Quack://MSG:[8-char]:[kyber_ct]:[aes_data]:[iv]
export const QUACK_MSG_REGEX = /Quack:\/\/(?:MSG:|_:)?(?:[A-Fa-f0-9]{8}:)?[A-Za-z0-9+/=]+:[A-Za-z0-9+/=]+(?::[A-Za-z0-9+/=]+)?/g;
...
export const DEFAULT_SETTINGS = {
  ...
  debugMode: false,
  stealthDecryption: true,       // Try all keys for stealth messages (default: enabled)
};
